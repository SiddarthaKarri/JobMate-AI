        ...
        <div className="resume-summary">
            <div className="category">
                <div className="flex flex-row gap-2 items-center justify-center">
                    <p className="text-lg sm:text-xl lg:text-2xl font-medium">{title}</p>
...
const Summary = ({ feedback }: { feedback: any }) => {
    ...
    const toneAndStyleScore = feedback.toneAndStyle?.score || 80;
    const contentScore = feedback.content?.score || 85;
    const structureScore = feedback.structure?.score || 78;
